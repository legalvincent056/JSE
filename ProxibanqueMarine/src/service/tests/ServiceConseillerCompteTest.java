...
public class ServiceConseillerCompteTest {
	...
	public void testAjouterCompteEpargneClient() {
		IConseillerCompte sc = new ServiceConseiller(); //Création d'un service
		...
		sc.AjouterCompteClient(c2,ce1);	//Appel de la méthode ajouterCompteClient pour associer le compte1 au client2
	...
	public void testAjouterCompteEpargneClient2() {
		...
		sc.AjouterCompteClient(c2, ce2); //Appel de la méthode AjouterCompteClient pour essayer d'ajouter le compte 2 au client2
