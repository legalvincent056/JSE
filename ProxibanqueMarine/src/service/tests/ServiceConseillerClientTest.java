...
public class ServiceConseillerClientTest {
	...
	public void testAjouterClient() {
		...
		IConseillerClient sc = new ServiceConseiller();	//Créer un service
		...
		sc.AjouterClient(conseiller2, client2); //Appel à la méthode AjouterClient:Association client 2 au conseiller 2
	...
	public void testAjouterClient2() {
		IConseillerClient sc = new ServiceConseiller();
	...
	public void testModifierClient() {
		IConseillerClient sc = new ServiceConseiller(); //Création d'un service
	...
	public void testSupprimerClientParticulier() {
		...
		IConseillerClient ge = new ServiceConseiller();	//Création d'un service
