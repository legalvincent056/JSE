...
public class ServiceConseillerSimulationTest {
	...
	@Test
	public void testEffectuerSimulationCredit() {
		IConseillerSimulation sc = new ServiceConseiller(); //Création d'un service
	...
	public void testEffectuerSimulationCredit2() {
		IConseillerSimulation  sc = new ServiceConseiller();
		double montant=-200;
		int taux=3;
		int duree=24;//mois
